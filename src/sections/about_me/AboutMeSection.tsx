        ...
        <div className="flex flex-col px-5 md:flex-row md:px-20">
          <div className="order-2 font-roboto md:order-1 md:w-7/12 md:pr-4">
            <Transition>
              ...
              technologies, mastering languages such as HTML, CSS, JavaScript,
              and beyond. Beyond just writing lines of code, I'm committed to
              crafting solutions that not only meet but exceed expectations.
              Whether it's building responsive and user-friendly interfaces,
              optimizing website performance, or solving complex technical
              issues, I'm always eager to push the boundaries of what's
